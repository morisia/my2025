...
import { ArrowLeft, User, MapPin, CreditCard, FileText, Package as PackageIcon, CalendarDays, Phone, Loader2, AlertTriangle, ShoppingBasket } from "lucide-react";
...
export default function UserOrderDetailPage() {
  ...
  useEffect(() => {
    ...
    const fetchOrder = async () => {
        ...
        try {
            ...
            if (orderDocSnap.exists()) {
                ...
                if (fetchedOrder.userId !== firebaseUser.uid) {
                    setError("ამ შეკვეთაზე წვდომა არ გაქვთ.");
                    setOrder(null);
                } else {
    ...
    fetchOrder();
  }, [orderId, firebaseUser, authCheckDone, router]);
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <Button variant="outline" onClick={() => router.push('/profile')}>
          <ArrowLeft className="mr-2 h-4 w-4" /> უკან პროფილზე
        </Button>
      </div>
